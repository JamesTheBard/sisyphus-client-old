from helpers.font import generate_font_list, generate_style_map, generate_font_map, FontNotFoundError
...
try:
    ...
    print(f"Could not find a font for style '{e.style.style}': font => '{e.style.family}/{'+'.join(e.style.subfamily)}'")
    sys.exit(1)
